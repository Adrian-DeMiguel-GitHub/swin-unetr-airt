...
#Code: https://github.com/ternaus/robot-surgery-segmentation/tree/master
...
class UNet_VGG11(nn.Module):
    def __init__(self, in_channels=10, out_classes=2, num_filters=32, pretrained=False):
        """
        :param num_filters:
        :param pretrained:
        ...
        # Load VGG11 without pre-trained weights
        vgg11 = models.vgg11(pretrained=False)
        
        # Modify the first convolutional layer to accept 10 input channels
        vgg11.features[0] = nn.Conv2d(in_channels=self.in_channels, out_channels=64, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
        ...
        self.final = nn.Conv2d(num_filters, self.out_classes, kernel_size=1)
